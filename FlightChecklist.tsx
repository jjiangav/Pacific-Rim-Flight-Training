...
const HOTSPOTS_GWTE: AircraftHotspots = {
  ...
  'pfi-9':  { image: 'real',    x: 30, y: 44, w: 12, h: 12 },
  ...
  'sc-1':   { image: 'real',    x: 38, y: 40, w: 12, h: 12 },
  ...
  'sc-10':  { image: 'real',    x: 40, y: 38, w: 12, h: 12 },
  ...
  'ptc-5':  { image: 'real',    x: 31, y: 45, w: 12, h: 12 },
